...
const encrypt = async (data: Uint8Array, keyData: Uint8Array, iv: Uint8Array, additionalData: Uint8Array): Promise<Uint8Array> => {
...
const decrypt = async (cipherAndTag: Uint8Array, keyData: Uint8Array, iv: Uint8Array, additionalData: Uint8Array): Promise<Uint8Array> => {
  const key = await subtle.importKey("raw", keyData, "aes-gcm", true, keyUsages);
